...
// 620 was the target draw height when fighters rendered at the plain 1.0 scale; now that
// STAGE_HEIGHT_SCALE.memorial matches bayou's 1.8, the background has to grow by the same
// factor to keep the statue/steps proportioned the same relative to the (now bigger)
// fighters -- otherwise they'd tower over the memorial instead of just rendering bigger.
const MEMORIAL_FRONT_SCALE = (620 * 1.8) / MEMORIAL_FRONT_SRC_H;
